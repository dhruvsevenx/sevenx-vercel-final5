...
/**
 * Global / iGaming variant of the SevenX site.
 * Served automatically to non-India visitors and Google searches with
 * iGaming intent. Also reachable via the Region Toggle from the India site.
 */
export default function GlobalHome() {
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      document.title = "SevenX Media | iGaming, Casino, Sportsbook & Crypto Marketing Agency — Licensed Jurisdictions";
      // patch description dynamically for the global route
      let desc = document.querySelector('meta[name="description"]');
      if (desc) {
        desc.setAttribute(
          "content",
          "SevenX Media is a global iGaming, sportsbook, casino, poker and crypto performance marketing agency. We operate strictly inside licensed jurisdictions (MGA, UKGC, KGC, Curacao, Ontario iGO, Colombia Coljuegos, Brazil SPA) and do not market these services in India."
        );
      }
    }
  }, []);
          ...
          <section className="relative px-6 md:px-10 py-16 md:py-24 border-t border-[#0F1B36]" data-testid="jurisdiction-notice">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              <div className="md:col-span-4">
                ...
                <h3 className="font-display text-3xl md:text-5xl uppercase leading-[0.9] tracking-tight text-[#E6EDFF]">
              ...
              <div className="md:col-span-8 space-y-4 font-mono text-[12px] md:text-sm text-[#9BB0D6] leading-[1.8]">
                <p>
                  SevenX Media provides iGaming, sportsbook, casino, poker, lottery, fantasy sports and crypto/Web3 performance marketing services <strong className="text-white">exclusively for operators holding valid licenses</strong> in the jurisdictions they wish to advertise in.
                </p>
                <p>
                  We work with, and only with, brands licensed by <strong className="text-white">MGA (Malta), UKGC (United Kingdom), KGC (Kahnawake), Curacao Gaming, Ontario iGO (Canada), Colombia Coljuegos, Brazil SPA, Nigeria NLRC, South Africa WCGRB, MiCA (EU), FINTRAC (Canada) and equivalent regulators</strong>. Every creative, landing page and affiliate flow is cleared against the local advertising code before spend goes live.
                </p>
